...
| Outer rise (`outer_rise`) | M1/R3 | tiny | pre-registered marginal below 1024²; **ablation pair** (standing suspicion now testable) | trim-review sheet 2026-08-28 (out/trim_review/): author "can hardly tell a difference" — the seaward bulge is sub-band at quantize 12 even at 1024²/4 km | trim-candidate, **seaward bulge only** — the knob stays: it carries K2's foreland (belt anatomy). Bulge-only trim awaits author authorization by name |
